  ...
  async fetch(req) {
    ...
    if (req.method === "GET" && path === "/manifest.webmanifest") {
      return Response.json({
        ...
        icons: [
          { src: "/_ct/pwa/icon-192.png?v=5", sizes: "192x192", type: "image/png", purpose: "any" },
          { src: "/_ct/pwa/icon-512.png?v=5", sizes: "512x512", type: "image/png", purpose: "any" },
          { src: "/_ct/pwa/icon-maskable-192.png?v=5", sizes: "192x192", type: "image/png", purpose: "maskable" },
          { src: "/_ct/pwa/icon-maskable-512.png?v=5", sizes: "512x512", type: "image/png", purpose: "maskable" },
        ],
